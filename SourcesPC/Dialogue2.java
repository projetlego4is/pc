...
public class Dialogue2 extends JDialog implements ActionListener {
	...
	public Interface_graphique_2 graph ;
	...
	private JTextField saisieX, saisieY, saisie_l, saisie_L, saisie_angle, saisie_pas ;  
	private JButton valider = new JButton("Valider") ;
	private JButton annuler = new JButton("Annuler") ;
	private JButton ok = new JButton("OK") ;
	private JButton changerObj = new JButton("Changer les objectifs") ;
		
	public Dialogue2(int c, int no_obj, Interface_graphique_2 inter) {
		...
		//***********************************************//
			...
			//Pas
			panneau = new JPanel() ;
			JLabel label_pas = new JLabel("Pas d'espacement des points");
			panneau.add(label_pas);
			saisie_pas = new JTextField(5);
			panneau.add(saisie_pas);
			boite.add(panneau);
			
			//Angle
			panneau = new JPanel() ;
			JLabel label_angle = new JLabel("Angle d'orientation des arcs (en degré)");
			panneau.add(label_angle);
			saisie_angle = new JTextField(5);
			panneau.add(saisie_angle);
			boite.add(panneau);
		...
		if (e.getSource() == valider) {
			...
			if (this.choix == DEPART || this.choix == ARRIVEE || this.choix == OBJECTIFS) {
				...
				try {
					...
					double L_saisie = new Double(this.saisie_L.getText()) ;
					double angle_saisie = new Double(this.saisie_angle.getText()) ;
					double pas_saisie = new Double(this.saisie_pas.getText()) ;
					
					if (l_saisie<0 || L_saisie<0 || angle_saisie<0 || pas_saisie<0) {
