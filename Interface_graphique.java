...
public class Interface_graphique extends JFrame implements ActionListener {
	...
	public Interface_graphique() {
		...
		//Ajout de l'image
		this.ajouter_img("photo_nous.jpg", 0, 0) ;
	...
	public void actionPerformed(ActionEvent e) {
		...
		//***********************************************//
	     if (e.getSource() == bouton_dep) { 
	    	 Dialogue dialog = new Dialogue(DEPART, 0, this) ;
	    	 if (dialog.dep != null && dialog.annule == false) {
	    		 ...
	    		 this.label_dep.setForeground(vert) ;
	     ...
	     //***********************************************//
	    	 ...
	    	 Dialogue dialog = new Dialogue(ARRIVEE, 0, this) ;
	    	 if (dialog.arr != null && dialog.annule == false) {
	    		 ...
	    		 this.label_arr.setForeground(vert) ;
	     ...
	     //***********************************************//
	    	 ...
	    	 Dialogue dialog = new Dialogue(DIMENSION, 0, this) ;
	    	 try {
	    		 if (dialog.annule == false) {
			    	 ...
			    	 if (this.carte_OK == false) {
			    		 ...
			    		 this.label_dim.setForeground(vert) ;
			    	 }
			    	 //Redéfinition
			    	 else {
			    		 this.label_dim.setText("Dimension de la carte : "+this.largeur+"X"+this.longueur) ;
	...
	public void actionObj () {
		System.out.println(this.carte_OK) ;
	   	 Dialogue dialog = new Dialogue(NB_OBJECTIFS, 0, this);
		 ...
		 if (this.nbr_obj != 0 && dialog.annule == false) {
			 ...
			 for (no_obj = 1 ; no_obj <= this.nbr_obj ; no_obj++) {
				 Dialogue dialog2 = new Dialogue(OBJECTIFS, no_obj, this) ;
	    		 if (this.nbr_obj != 0 && dialog.annule == false) {
		...
		//Une fois les objectifs définis
		 if (this.nbr_obj!=0) {
			 ...
			 this.label_nb.setForeground(vert) ;
		 } else {
			 this.label_nb.setText("0 objectif défini") ;
			 this.label_nb.setForeground(Color.black) ;
		 }
